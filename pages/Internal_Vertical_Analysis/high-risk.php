<?php include '../../partials/document_header.php'; ?>
    ...
    <p>
        The following are the areas of Vertical Risk assessed according to: Risk, Theme,
        Magnet<sup>&reg;</sup> Requirement, Observations/Gap(s) and Recommendations:
    </p>
	...
	<object 
		...
		data="<?php echo $ATTACHDIR; ?>/mypdf.pdf#page=3"
